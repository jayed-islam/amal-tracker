...
//                     border: Border.all(
//                         color: context.colors.goldBorder2, width: 0.8),
//                   ),
//                   child: const Center(
...
// ─────────────────────────────────────────────────────────────────────────────
// SADAQAH BANNER
// Redesigned to actually draw the eye and invite curiosity, not just sit
// there as a flat static card:
//  - the icon badge has a slow, gentle "breathing" pulse
//  - the trailing chevron gives a small periodic nudge (a very common,
//    tasteful "tap me" cue)
//  - a faint, infrequent shine sweeps across the gradient — subtle enough
//    not to feel like an ad banner, just enough to catch a passing glance
//  - copy now references the well-known "up to 700x" multiplier for
//    sadaqah (Surah Al-Baqarah's grain parable, paraphrased — not a
//    verbatim quotation) as a small pill, since a concrete number tends to
//    spark curiosity more than a general statement
    ...
    return GestureDetector(
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            // Warm gold gradient — distinct from the green hero, softer feel.
            // Both stops are existing theme tokens, so this still looks
            // right if/when a dark theme is added.
            gradient: LinearGradient(
          ...
          child: Stack(children: [
            // Soft decorative circles for a bit of depth — same visual
            // language as the home screen's hero card, instead of a flat
            // single-tone rectangle.
            Positioned(
              top: -22,
              right: -18,
              child: Container(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 11),
              child: Row(children: [
                // Icon container — gentle breathing pulse to catch a
                // passing glance without being distracting.
                Container(
                  width: 36,
                  height: 36,
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        const SizedBox(width: 6),
                        // Curiosity hook — a concrete number tends to make
                        // people want to know more than a general phrase.
                        Container(
                      ...
                      const SizedBox(height: 2),
                      Text(
                        'আল্লাহর রাস্তায় ব্যয় করুন, সওয়াব বহুগুণ বাড়ান',
                        style: TextStyle(
                ...
                // Chevron — a small periodic nudge instead of sitting
                // perfectly still, a common and tasteful "tap here" cue.
                Icon(
        ...
        // Very faint, infrequent shine sweep — subtle enough to read as a
        // gentle glint rather than a loading skeleton or an ad banner.
