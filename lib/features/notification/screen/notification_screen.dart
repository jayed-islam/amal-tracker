...
// // In-app notification history / inbox for Amal Tracker
// // Shows: amal reminders acted on, weekly reviews, push msgs
// // ============================================================
...
//           return _NotificationList(provider: provider);
//         },
//       ),
//     );
//   }
...
//                 style:
//                     TextStyle(color: Color(0xFF6B8A82), fontFamily: 'Poppins')),
//           ),
//           TextButton(
//             onPressed: () {
//               provider.clearAll();
...
//   const _NotificationList({required this.provider});
...
//                   notification: notif,
//                   onTap: () => _onTap(context, notif, provider),
//                   onDismiss: () => provider.deleteNotification(notif.id),
//                 )),
//           ],
//         );
//       },
...
//   void _onTap(
//       BuildContext ctx, AppNotification notif, NotificationProvider provider) {
//     provider.markAsRead(notif.id);
//     if (notif.route != null && notif.route!.isNotEmpty) {
//       Navigator.pushNamed(ctx, notif.route!);
//     }
//   }
// }
...
//           decoration: BoxDecoration(
//             color: notification.isRead ? Colors.white : const Color(0xFFF0FAF5),
...
//                       ),
//                       // Tap hint for actionable notifications
...
//                                   size: 12, color: Color(0xFF2E7D5E)),
//                               const SizedBox(width: 4),
//                               Text(
//                                 _routeLabel(notification.route!),
//                                 style: const TextStyle(
//                                   fontFamily: 'Poppins',
//                                   fontSize: 11,
//                                   color: Color(0xFF2E7D5E),
...
//       '/log-amal': 'Tap to log amal',
//       '/weekly-review': 'Tap to see review',
//       '/': 'Tap to open',
//     };
//     return labels[route] ?? 'Tap to open';
//   }
// }
...
//           const Text(
//             'Your amal reminders and updates\nwill appear here.',
...
// }
// ============================================================
// notification_center_page.dart  — Bangla + Riverpod
// ============================================================
