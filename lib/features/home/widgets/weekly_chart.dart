...
//   void initState() {
//     super.initState();
//     // চার্ট লোড হওয়ার পর ডিফল্টভাবে আজকের দিনটি সিলেক্টেড থাকবে
...
//     // গ্রাফের Y-Axis (উচ্চতা) ডাইনামিকালি সেট করার জন্য সর্বোচ্চ পয়েন্ট খুঁজে বের করা
//     double maxPoints = 20;
...
//                         // ব্যাকএন্ড থেকে আসা ডাইনামিক দিন (Sun, Mon...) এখানে রেন্ডার হবে
...
//                   // জেন্ডার ও ট্র্যাকিং স্ট্যাটাস অনুযায়ী ডাইনামিক কালার নির্ধারণ
...
//                         // ব্যাকগ্রাউন্ড ট্র্যাকিং বার (শ্যাডো ইফেক্ট)
//                         backDrawOpacity: 1,
//                         backgroundBarChartRodData: BackgroundBarChartRodData(
//                           show: true,
//                           toY: maxPoints,
...
//           // ── ডাইনামিক ইনফরমেশন প্যানেল (জেন্ডার এবং সিলেক্টেড ডে অনুযায়ী চেঞ্জ হবে) ──
...
//             Row(
//               children: [
//                 // কার্ড ১: ফরজ আমল কাউন্টার (সবার জন্য)
//                 Expanded(
//                   child: Container(
...
//                 // কার্ড ২: জেন্ডার অনুযায়ী পরিবর্তনশীল কার্ড (পুরুষদের জামাত / নারীদের সুন্নাত)
//                 Expanded(
//                   child: Container(
//                     padding: const EdgeInsets.all(10),
//                     decoration: BoxDecoration(
...
//                                   : '${selectedData.jamatCount} ওয়াক্ত')
//                               : '--',
//                           style: const TextStyle(
//                               color: _C.darkGreen,
//                               fontWeight: FontWeight.w800,
