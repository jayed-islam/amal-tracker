...
//     // ── Step 1: Warn about grace period ──────────────────────────────────────
...
//       iconBg: _C.redLight,
//       title: 'অ্যাকাউন্ট মুছবেন?',
//       body: '৩০ দিনের জন্য আপনার অ্যাকাউন্ট নিষ্ক্রিয় হবে।\n\n'
//           'এই সময়ের মধ্যে লগইন করে যেকোনো সময় বাতিল করতে পারবেন। '
//           '৩০ দিন পর সমস্ত ডেটা স্থায়ীভাবে মুছে যাবে।',
//       confirmText: 'পরবর্তী',
//       confirmColor: _C.red,
//       apiCall: () async {},
//       onSuccess: () {},
...
//     // ── Step 2: Final confirmation + API call ─────────────────────────────────
//     final step2 = await _showConfirm(
//       context,
//       icon: Icons.warning_amber_rounded,
//       iconColor: _C.red,
//       iconBg: _C.redLight,
//       title: 'সত্যিই নিশ্চিত?',
//       body: 'এখন থেকে ৩০ দিন গণনা শুরু হবে। '
//           'পরের মাসের আমল ডেটা, পয়েন্ট ও র‍্যাংকিং সব মুছে যাবে।',
//       confirmText: 'হ্যাঁ, মুছুন',
//       confirmColor: _C.red,
//       // apiCall throws on failure → _ConfirmDialog catches it → step2.success=false
//       apiCall: () async {
//         final result = await ref.read(authProvider.notifier).requestDeletion();
//         if (result == null) throw Exception('অ্যাকাউন্ট মুছতে ব্যর্থ হয়েছে');
//       },
//       onSuccess: () {},
//     );
...
//     if (step2.success) {
//       // Show goodbye sheet — state already has pendingDeletion + unauthenticated
//       final info = ref.read(pendingDeletionProvider);
//       await _showGoodbyeSheet(context, info?.daysLeft ?? 30);
...
//             Text(
//               '$daysLeft দিন পর আপনার সমস্ত ডেটা স্থায়ীভাবে মুছে যাবে।\n\n'
//               'এই সময়ের মধ্যে লগইন করে "অ্যাকাউন্ট ফিরিয়ে আনুন" বাটনে '
//               'ক্লিক করলে সব ডেটা ফিরে পাবেন।',
//               textAlign: TextAlign.center,
//               style: const TextStyle(
//                 color: _C.textSecondary,
//                 fontSize: 13,
